...
let index = 0; // Track the current title
let charIndex = 0; // Track the current character of the title
let isDeleting = false; // Track if it's deleting
const typingSpeed = 100; // Speed of typing in milliseconds
const erasingSpeed = 50; // Speed of erasing in milliseconds
const delayBetweenTitles = 150; // Delay before starting to erase (after typing completes)
...
function typeEffect() {
  ...
  if (!isDeleting && charIndex <= titles[index].length) {
    // Typing characters
    titleElement.textContent = titles[index].substring(0, charIndex);
    charIndex++;
    ...
    // Move to the next title after erasing
    isDeleting = false;
